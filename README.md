...
## Human Aspects
- **The Effects of Human Aspects on the Requirements Engineering Process: A Systematic Literature Review** (2022), TSE 2022. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9325916)
...
- **Dealing with Non-Functional Requirements in Model-Driven Development: A Survey** (2021), TSE 2021. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=8665968)
- **FREPA: An Automated and Formal Approach to Requirement Modeling and Analysis in Aircraft Control Domain** (2020), FSE 2020. [[pdf]](https://arxiv.org/pdf/2306.01260.pdf)
- **Prema: A Tool for Precise Requirements Editing, Modeling and Analysis** (2020), ASE 2020. [[pdf]]()
- **Automated Reuse of Model Transformations through Typing Requirements Models** (2019), TOSEM 2019. [[pdf]](https://dl.acm.org/doi/pdf/10.1145/3340108)
...
- **How Templated Requirements Specifications Inhibit Creativity in Software Engineering** (2022), TSE 2022. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9537306)
...
- **On user rationale in software engineering** (2018), Requir.Eng 2018. [[pdf]]()
- **Online app review analysis for identifying emerging issues** (2018), ICSE 2018. [[pdf]]()
- **SAFE: A Simple Approach for Feature Extraction from App Descriptions andApp Reviews** (2017), RE2017. [[pdf]]()
- **Automated Extraction and Clustering of Requirements Glossary Terms** (2017), TSE 2017. [[pdf]](https://ieeexplore.ieee.org/document/7765062)
- **What would users change in my app? summarizing app reviews for recommending software changes** (2016), FSE 2016. [[pdf]]()
- **Phrase-based extraction of user opinions in mobile app reviews** (2016), ASE 2016. [[pdf]]()
- **What Parts of Your Apps are Loved by Users** (2015), ASE 2015. [[pdf]]()
- **Mining User Opinions in Mobile App Reviews: A Keyword-Based Approach** (2015), ASE 2015. [[pdf]]()
- **How Do Users Like This Feature? A Fine Grained Sentiment Analysis of App Reviews** (2014), RE 2014. [[pdf]]()
...
- **Applying deep learning based automatic bug triager to industrial projects** (2017), FSE 2017. [[pdf]]()
- **How can i improve my app? Classifying user reviews for software maintenance and evolution** (2015), ICSME 2015. [[pdf]]()
- **Bug report, feature request, or simply praise? On automatically classifying app reviews** (2015), RE 2015. [[pdf]]()
- **AR-miner: mining informative reviews for developers from mobile app marketplace** (2014), ICSE 2014. [[pdf]]()
...
- **A Zone-Based Model for Analysis of Dependent Failures in Requirements Inspection** (2023), TSE 2023. [[pdf]](https://dl.acm.org/doi/10.1109/TSE.2023.3266157) 
- **Detecting Software Security Vulnerabilities Via Requirements Dependency Analysis** (2022), TSE 2022. [[pdf]](https://ieeexplore.ieee.org/document/9222252)

## Requirements Changes
- **The Emotional Roller Coaster of Responding to Requirements Changes in Software Engineering** (2023), TSE 2023. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9769966)
- **A Framework for Emotion-Oriented Requirements Change Handling in Agile Software Engineering** (2023), TSE 2023. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10061282)
- **A Faceted Taxonomy of Requirements Changes in Agile Contexts** (2022), TSE 2022. [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9513607)
- **A Prediction Model for Software Requirements Change Impact** (2o21), ASE 2021. [[pdf]](https://ieeexplore.ieee.org/document/9678582)
- **Automated change impact analysis between SysML models of requirements and design** (2016), FSE 2016. [[pdf]](https://dl.acm.org/doi/pdf/10.1145/2950290.2950293)
- **NARCIA: an automated tool for change impact analysis in natural language requirements** (2015), FSE 2015. [[pdf]](https://dl.acm.org/doi/pdf/10.1145/2786805.2803185)

## Requirements Traceability
- **Cross-Domain Requirements Linking via Adversarial-based Domain Adaptation** (2023), ICSE 2023. [[pdf]](https://ieeexplore.ieee.org/document/10172688/)
...
- **Semantically enhanced software traceability using deep learning techniques** (2017), ICSE 2017. [[pdf]]()
